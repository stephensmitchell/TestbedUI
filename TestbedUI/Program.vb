...
Module Program
    ...
    Public Sub Main(args As String())
        ...
        app = New Application()
        Dim uiThread As New Thread(Sub()
    ...
    Private Sub ProcessCommand(command As String)
        ...
        Select Case command
            Case "u1"
                StartUIWindow("TestbedUI Design 01 - DEV MODE", AddressOf EyeshotWindowLayout.BuildGrid2)
            Case "u2"
            ...
            Case "u5"
                StartUIWindow("TestbedUI Design 05 - DEV MODE", AddressOf EyeshotLoadStepWindowLayout.BuildGrid)
            Case "/r" 'TODO: Add restart functionality
                Console.WriteLine("Restarting the application...")
            Case "/c"
                'TODO: cleanup test methods
                LoadCalca()
